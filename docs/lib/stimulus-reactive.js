...
function useStimulusReactive(identifier, application) {
    const definition = application.router.modules.find((module) => module.identifier === identifier);
    ...
    const methods = getPropertyDescriptors(prototype, /^initialize|disconnect|(.+)(ValueChanged|OutletConnected|OutletDisconnected)$/);
    function initialize() {
    ...
    function _initialize() {
        ...
        Object.entries(outlets).forEach(([key, { get: originalGet }]) => {
            ...
            Object.defineProperty(this, key, {
                get() {
                    var _a;
                    const ref = this.__reactive.state[outletsKey];
                    return (_a = ref.value[0]) !== null && _a !== void 0 ? _a : originalGet.call(this);
                },
            });
        });
    }
    ...
    function valueChanged(name) {
        ...
        Object.defineProperty(prototype, valueChangedKey, {
            value: function (value, previousValue) {
                ...
                (_b = (_a = methods[valueChangedKey]) === null || _a === void 0 ? void 0 : _a.value) === null || _b === void 0 ? void 0 : _b.call(this, value, previousValue);
            },
        });
    }
    function outletConnected(name) {
        ...
        Object.defineProperty(prototype, connectedKey, {
            value: function (controller, element) {
                ...
                (_b = (_a = methods[connectedKey]) === null || _a === void 0 ? void 0 : _a.value) === null || _b === void 0 ? void 0 : _b.call(this, controller, element);
            },
        });
    }
    function outletDisconnected(name) {
        const outletsKey = `${name}s`;
        ...
        Object.defineProperty(prototype, disconnectedKey, {
            value: function (controller, element) {
                ...
                (_b = (_a = methods[disconnectedKey]) === null || _a === void 0 ? void 0 : _a.value) === null || _b === void 0 ? void 0 : _b.call(this, controller, element);
            },
        });
    }
